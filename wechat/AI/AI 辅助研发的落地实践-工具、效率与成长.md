> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [mp.weixin.qq.com](https://mp.weixin.qq.com/s/IkyG70gCSNDXpZjCetV0Gg)
...
> 对于绝大多数开发者来说，擅长使用 AI 能节省最少 50% 的开发成本。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUTRVS9ZFwqlpNZWAOHGn7y0E5uSufddkqsmdGVtkt7a5wHCDn4HDTZA/640?wx_fmt=other&from=appmsg#imgIndex=0)image.png
...
下图为简易流程展示：![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUiaEicSJXmH7rH3o3AYwibPCRns253PPgJCcsOZxk3BCZplXRlA9rLRGBQ/640?wx_fmt=other&from=appmsg#imgIndex=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUd2VdT5s4fF0zLrKiaNWZ8pCIV2t5W3Af0yHwicRZzgMCY7Kd6FIqRPBw/640?wx_fmt=other&from=appmsg#imgIndex=2)image.png

因此，我们将问题也抛给 AI，让它修改一下界面交互。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUjtAGnwEDib8jXDAKtibKLVNY9jmH62kcKhf6qYIaCFYsZ4j9bsAicIqCQ/640?wx_fmt=other&from=appmsg#imgIndex=3)image.png
...
AI 编辑器`Cursor`、`Trae`等可以通过定制规则，让 AI 的输出更符合用户的个性化要求。通过定制规则，让 AI 的回答以我们想要的模版输出。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUdMy3ibW5HMS51xUYAFX5Fzf5Dicga3mexCRGUzBFMhqxv1bM8IpVHyrg/640?wx_fmt=other&from=appmsg#imgIndex=4)image.png

进入规则面板，找到项目规则，点击`Add&nbsp;Rule`新增规则，选择自定义规则

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUYhOuyyOMdrxlsqGcEGAcNoWKMxEc18y5MyoRa1jX9QYjiclq2VnsqSg/640?wx_fmt=other&from=appmsg#imgIndex=5)image.png

输入合法的规则名称后，回车创建，即可在根目录下看到规则文件

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUDseibn3abqmozbictwcPt4mqrPnXzmTPYibNNYFI8kicpdjicoqDA2yUXUw/640?wx_fmt=other&from=appmsg#imgIndex=6)image.png![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibURrfPnSB9FMpKhkTnEiaheOngiajEu035CjJkmtffVkMuBiafm63icmpfjQ/640?wx_fmt=other&from=appmsg#imgIndex=7)image.png

**（2）编辑规则：**

编辑新创建的规则文件`xxxx.mdc`

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUrVRa77roUmMMN4p1l7cUtnUYib4HwhCiaWBzm08k0r63IRJICb8QwdBQ/640?wx_fmt=other&from=appmsg#imgIndex=8)image.png
...
1.  **提供参考资料给 AI（这一过程也可以直接让 AI 完成）**
    

*   市面上已有的同类产品、解决方案链接
    
*   相关文件、文档等上下文（例如需求分析文档、YApi 官方文档）
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUIWeHlyR1libg6aicVolJKricSRMIwGTj0ND20aRYtpGHwMpMYxEd0MeoQ/640?wx_fmt=other&from=appmsg#imgIndex=9)image.png
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUBag7ic58m2gRiaOKFCMQrswTCicRLp5DhvOTCoUAFPyO7xWJhrbNBmBMQ/640?wx_fmt=other&from=appmsg#imgIndex=10)image.png![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUnCqZT5PmZzSy1amvEKt10qhmP3GkPqQicTSTvEOQJ6RbKp8WCDneQVA/640?wx_fmt=other&from=appmsg#imgIndex=11)image.png

*   **功能点二：接口管理（筛选、刷新、状态更新提示）**
    
    ![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUsBVagf3talTNOd3DUVhiblRNyFaaibicDjO4pYIibcxacvqw0FPNnP91Aw/640?wx_fmt=other&from=appmsg#imgIndex=12)image.png![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibU2jicBpu74icr5bSxE7SetNBL2vicCVnns8Lr9tA6PO180o9kibhYlB3VJQ/640?wx_fmt=other&from=appmsg#imgIndex=13)image.png
    
*   **功能点三：API 分析**
    

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUgJseGc8XqaRIU4ibFKiargUygadKO6xMMWicw5PQlDHWYzhL94jZ4IQjg/640?wx_fmt=other&from=appmsg#imgIndex=14) image.png![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUDJfk82EYCEKgte9JZ2RtiaahzDcibsIYxxX6NxCmK70OmtWJlCusjqdg/640?wx_fmt=other&from=appmsg#imgIndex=15)image.png

**功能点四：组件信息提示（属性补全、组件及属性提示）**

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibU6aQHgEJDsgpiahHetXGntWAaOVzp9icibqOa7kLMWr9EL2FRZOhcwouYA/640?wx_fmt=other&from=appmsg#imgIndex=16)image.png![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUvyFlbAwcartvVUFeicXecjOjwYJVFOkibiakFxCgPZId8NhR65RTdKglg/640?wx_fmt=other&from=appmsg#imgIndex=17)image.png![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUeKeVlVcbSIChkYdBuBx9U9ofxxuzNCLyia4dKZBESy5pwdUnBep8JpQ/640?wx_fmt=other&from=appmsg#imgIndex=18)image.png
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUgDtfyttLdic8ia5umiaGz12v6YWfZp7DMg3013bwpAia6xJSz280UnfHQg/640?wx_fmt=other&from=appmsg#imgIndex=19) image.png

*   **功能二：其它楼层透明化**
    

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUQVPpPaocYUBSQNQiaHCYzFhwOgYfOLAH8voL4n0URcUl5ribWHKBsiaVg/640?wx_fmt=other&from=appmsg#imgIndex=20) image.png

*   **功能三：单楼层预览**
    

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibU1O9sGzibQa84jKBcGenk3Dkbn8jS4CbTSEc6KUicqx8weYrgiboV3W5mQ/640?wx_fmt=other&from=appmsg#imgIndex=21) image.png
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/YBFV3Da0NwtaLMibrL3uKpQ2Kj96axcibUDxIE5UUM7ibk6VgFxIUbThdjDbOQicibxXfEPibrjTk2WUIIhGSAyHjAYg/640?wx_fmt=other&from=appmsg#imgIndex=22)image.png
