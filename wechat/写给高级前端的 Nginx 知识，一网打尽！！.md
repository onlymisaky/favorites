> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [mp.weixin.qq.com](https://mp.weixin.qq.com/s/nf9Yif4DYqmUMvqxgI8Hvw)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/xVsWr7feY090btJAY42ARzO3YU9qHPJHGLWgTbzIHvlUHBDbCm2oWO425LN89DvYCJ0Ee558QsiarYhLUBP74cw/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1&tp=wxpic&random=0.7674578297766375)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/xVsWr7feY090btJAY42ARzO3YU9qHPJH3lbMYJKKx08mjbPPl2cpNLlrm20oUw3tK1c69RKqCfvMAN7NCib4G2w/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1&tp=wxpic&random=0.9017368443229996)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/xVsWr7feY090btJAY42ARzO3YU9qHPJHq3VYXIibU9Moohr3Fv7BW9MS7Nw1Y1cLXIduaHQ2L3KWOl8EaxSjXdw/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1&tp=wxpic&random=0.1466516042854893)
...
最终看到如上的`Nginx`欢迎界面，代表`Nginx`安装完成。推荐：[Java 面试题](https://mp.weixin.qq.com/s?__biz=MzIyNDU2ODA4OQ==&mid=2247494231&idx=1&sn=287fd16b4657a32ad91e8108bbcbbe44&scene=21#wechat_redirect)
...
![](https://mmbiz.qpic.cn/mmbiz_gif/6mychickmupWISYmibEgTX2swLX1yFa5Iyl5KTic8niaricRU97kUicZRiaVB0HiaayHJM88icO9tXCuKSDfOhSAUYGibhEg/640?wx_fmt=gif&wxfrom=5&wx_lazy=1&tp=wxpic&random=0.9301894676259901)负载均衡效果 - 动图演示
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/xVsWr7feY090btJAY42ARzO3YU9qHPJHZJibJ4yJm2t4ZEY95boImbazpRYDvW40jpoYhuK0HQDWPmxn5EbiaiaWQ/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1&tp=wxpic&random=0.8974510537368052)请求分发原理
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/xVsWr7feY090btJAY42ARzO3YU9qHPJHOVYXI9rfwgdkBI2vLRcia64Nn4M3qIfREdZUsP1UM5tAYw71Zv5m6Aw/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1&tp=wxpic&random=0.7704390057565991)淘宝首页

当浏览器输入`www.taobao.com`访问淘宝首页时，打开开发者调试工具可以很明显的看到，首页加载会出现`100+`的请求数，而正常项目开发时，静态资源一般会放入到`resources/static/`目录下：

![](https://mmbiz.qpic.cn/mmbiz_jpg/xVsWr7feY090btJAY42ARzO3YU9qHPJHZgXULShoRSM4aibJHb5UNQiauWic6yGty5VLRfkY1IOmBl4vQJ0zd2p4g/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1&tp=wxpic&random=0.7203878876450811)IDEA 工程结构
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/xVsWr7feY090btJAY42ARzO3YU9qHPJHqquplWk6t3hXu8LQ1HltasVAsaB2ia6icibwH7MYtC020aibCicIxnZeicog/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1&tp=wxpic&random=0.4316885781054993)

其中`static`目录下的`nginx_style.css`文件已被移除，但效果依旧存在（绿色字体 + 蓝色大边框)：

![](https://mmbiz.qpic.cn/mmbiz/eQPyBffYbucU3YYnB5Fvfaw8O67WQqDzmsYVpdvtl6gE2qWy9mUT6yljnvqAETSLKGG1l39vYKXQyCqnbbPniaA/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1&random=0.9401871471588625)移除后效果动图
...
![](https://mmbiz.qpic.cn/mmbiz_png/eQPyBffYbucU3YYnB5Fvfaw8O67WQqDzyCLM3FTm8y89vAz6EI7chmlDL7eMejYTbKeq8Ny7J8t3hLyFZn9kLA/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1&random=0.8791584355679971)
...
![](https://mmbiz.qpic.cn/mmbiz_png/eQPyBffYbucU3YYnB5Fvfaw8O67WQqDzMLcrkZPLPOZ01uvKv24aNz6JK57qZBpsa3TX62VSbG8YIRvRQ8gdSg/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1&random=0.22532256988013089)
...
上述的缓冲区参数，是基于每个请求分配的空间，而并不是所有请求的共享空间。当然，具体的参数值还需要根据业务去决定，要综合考虑机器的内存以及每个请求的平均数据大小。推荐：[Java 面试题](https://mp.weixin.qq.com/s?__biz=MzIyNDU2ODA4OQ==&mid=2247494231&idx=1&sn=287fd16b4657a32ad91e8108bbcbbe44&scene=21#wechat_redirect)
...
![](https://mmbiz.qpic.cn/mmbiz_png/eQPyBffYbucU3YYnB5Fvfaw8O67WQqDzsznFZYqbMXkRbz3ibOV5bGYOu4oyV5SRhwMosK8hp6zXcUzgROXrqcA/640?wx_fmt=png&random=0.4564450335050465)
...
![](https://mmbiz.qpic.cn/mmbiz_png/eQPyBffYbucU3YYnB5Fvfaw8O67WQqDzAUiao0GE11PaBDF9ftibg2lgicPSlGDELa1Xt4KGTn8Hto4iaHZ6SVCGpA/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1&random=0.18181060480881706)
...
OK~，根据如上配置了`Nginx`后，你的网站即可通过`https://`的方式访问，并且当客户端使用`http://`的方式访问时，会自动将其改写为`HTTPS`请求。推荐：[Java 面试题](https://mp.weixin.qq.com/s?__biz=MzIyNDU2ODA4OQ==&mid=2247494231&idx=1&sn=287fd16b4657a32ad91e8108bbcbbe44&scene=21#wechat_redirect)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/xVsWr7feY090btJAY42ARzO3YU9qHPJHIb4K4zOBC09ibSLECeNzXcykoMGWjBSoibRjr6RUWKvicrkmP7DWxibiaHQ/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1&tp=wxpic&random=0.7461375105755621)虚拟 IP-VIP
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/NFJQPYvH42bgRZZdkRBORFhxPsribyOYbyXAqWJwQJ6odHd7gHibumfz0LMLJCQeFkHL9ccwl2vAuwIlRj5tquww/640?wx_fmt=jpeg)Ping-VIP

外部通过`VIP`通信时，也可以正常`Ping`通，代表虚拟`IP`配置成功。推荐：[Java 面试题](https://mp.weixin.qq.com/s?__biz=MzIyNDU2ODA4OQ==&mid=2247494231&idx=1&sn=287fd16b4657a32ad91e8108bbcbbe44&scene=21#wechat_redirect)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/NFJQPYvH42bgRZZdkRBORFhxPsribyOYbSQLHM34vgLlY1jxGYY65BQtra6lLVNNLO9ibV0POGC1hibwkcaexVA4A/640?wx_fmt=jpeg)Nginx 宕机
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/NFJQPYvH42bgRZZdkRBORFhxPsribyOYbBDlvAXhRgrdapE0AOK8NZX2Qs8QeZ4Jb6HsR1K3O3QfqXHQKfQ07HQ/640?wx_fmt=jpeg)服务器故障
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/NFJQPYvH42bgRZZdkRBORFhxPsribyOYbSeeiaiaQibgGltRC8XICKYUCHdiaicb3tIicW26kq8a2IyS5XMXa6AaMCc1w/640?wx_fmt=jpeg)130 的 IP 情况
