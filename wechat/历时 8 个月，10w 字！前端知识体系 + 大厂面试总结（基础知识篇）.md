> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [mp.weixin.qq.com](https://mp.weixin.qq.com/s/reLQ4CTTrD7-N8f5VLwbuw)
...
历时 8 个月，10w 字！前端知识体系 + 大厂面试总结（基础知识篇）[1]
...
IntersectionObserver API 使用教程 [41]
...
![](https://mmbiz.qpic.cn/mmbiz_gif/gH31uF9VIibSibnS28VcW6XA2rK4ulxs2gL1FicqDRicoibYg7LJNYIvkkNIFJibXJ8GiaMDglPCwLSvp30cF0l6HSqzA/640?wx_fmt=gif)sticky.gif
...
杀了个回马枪，还是说说 position:sticky 吧 [47]
...
![](https://mmbiz.qpic.cn/mmbiz_gif/gH31uF9VIibSibnS28VcW6XA2rK4ulxs2g0eZQkiasy0ic3r67IwdMXyibA8KwzaFEEgptqJxYnI6t1gUHaMO8TgGtw/640?wx_fmt=gif)animation.gif
...
```
<html>  <div class="container">    <div class="ul">      <div class="li">小王同学加入了凹凸实验室</div>      <div class="li">小李同学加入了凹凸实验室</div>      <div class="li">小赵同学加入了凹凸实验室</div>      <div class="li">小马同学加入了凹凸实验室</div>      <!-- 重复插入第一条数据 -->      <div class="li">小王同学加入了凹凸实验室</div>    </div>  </div>  <style>    .container {      height: 30px;      overflow: hidden;      background-color: #256def;      color: #ffffff;      width: 300px;      border-radius: 30px;      text-align: center;    }    .ul{      animation: scroll 5s linear infinite;    }    .li{      line-height: 30px;      height: 30px;    }     @keyframes scroll {    0% {       transform: translate(0,0)    }    100% {      /* 120 = 4*30 不包含最后一条数据的总高度*/      transform: translate(0,-120px)    }  }  </style></html>
```

你可能不知道的 Animation 动画技巧与细节 [48]
...
历时 8 个月，10w 字！前端知识体系 + 大厂面试总结（算法篇）[49]

历时 8 个月，10w 字！前端知识体系 + 大厂面试笔记（工程化篇）[50]

历时 8 个月，10w 字！前端知识体系 + 大厂面试总结（前端框架 + 浏览器原理篇）[51]
...
elementUI 的 BEM 规范: https://juejin.cn/post/7096779382740107300#heading-2
