> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [mp.weixin.qq.com](https://mp.weixin.qq.com/s/kFrXciFCeCTWqYDq_AF6hA)
...
![](https://mmecoa.qpic.cn/sz_mmecoa_gif/4g5IMGibSxt41yLZ8iaaDAocoia3UzW8K9Qbmkx7fdySPqDN1T6JafaLlxWpoz5aX7HxQee1s1aovJ5Aibvvyd7xLA/640?wx_fmt=gif&from=appmsg#imgIndex=0)

![](https://mmecoa.qpic.cn/sz_mmecoa_png/4g5IMGibSxt4WIKibmA9iagfePgrODiaJLMYpn7bzPZXzBXUayXmWGRos1EcXmRpwCzYHmbwO0HicnSj0mFaaS6eOqg/640?wx_fmt=png&from=appmsg#imgIndex=1)

_**01**_

前  言

在如今基于 AI 搜索的对话舞台上，如果一段文字像老式打字机一样逐字逐句展现在屏幕上，那将是一种具有独特魅力的吸引力。

  
话不多说，先来看下最终的实现效果。

![](https://mmecoa.qpic.cn/sz_mmecoa_gif/4g5IMGibSxt4WIKibmA9iagfePgrODiaJLMYFGEtqGicibISJ2BnsDxMtKPkeIIU42SDo5aOhaeHV4dk4CtuMLIjR7aA/640?wx_fmt=gif&from=appmsg#imgIndex=2)
...
![](https://mmecoa.qpic.cn/sz_mmecoa_png/4g5IMGibSxt4WIKibmA9iagfePgrODiaJLMYfAFuxyLA6uhQ9ibI6jEP1xpHicQudBSp6rz8NPmg97h5soStaBrcD33Q/640?wx_fmt=png&from=appmsg#imgIndex=3)
...
![](https://mmecoa.qpic.cn/sz_mmecoa_jpg/4g5IMGibSxt4WIKibmA9iagfePgrODiaJLMYoufSzWME4ibWSbEricH6jf5lSUDlvfFuoAvrQHeUe0p5TsdGpoWHBmFg/640?wx_fmt=jpeg&from=appmsg#imgIndex=4)
...
![](https://mmecoa.qpic.cn/sz_mmecoa_png/4g5IMGibSxt4WIKibmA9iagfePgrODiaJLMYEGxrkTFvL1EDAOFMbMibqjKyn8mDNJNBaQI0srzLOUosfpMdGaMZ0Yw/640?wx_fmt=png&from=appmsg#imgIndex=5)
...
![](https://mmecoa.qpic.cn/sz_mmecoa_png/4g5IMGibSxt4WIKibmA9iagfePgrODiaJLMYeMxNgMCvVWEYs6EicEraj0VP6jwl5YRwBKJ1U4JS55uVDiawnCYfKhkg/640?wx_fmt=png&from=appmsg#imgIndex=6)
...
if N <= 10 , Vnew = 100 ms / 1 字符

if 10 <N <= 20 , Vnew = 100 - 8 * ( N - 10) ms / 1 字符

if 20 < N , Vnew = 20 ms / 4 字符
