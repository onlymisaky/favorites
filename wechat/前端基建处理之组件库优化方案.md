> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [mp.weixin.qq.com](https://mp.weixin.qq.com/s/hY2p997w-qxK3HJk6BcGTw)
...
配合运维，绑定好分支，然后当指定分支有 merge 或者 Push 的时候，触发构建，这个根据自己团队的情况去部署即可。  
笔者部署完的大概样子如下：
